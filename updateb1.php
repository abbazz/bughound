...
?>
	...
	<p>
		...
		$con = mysqli_connect("localhost","root");
				mysqli_select_db($con, "bughound");
		$sql= mysqli_query($con,"SELECT distinct program_name from programs");
		...
		Date: <input name="rep_date" type="date" readonly>
		</p>
		<hr>
		<p>
		...
		$con = mysqli_connect("localhost","root");
				mysqli_select_db($con, "bughound");
		$sql= mysqli_query($con,"SELECT distinct funct_area from areas");
		while ($row = $sql->fetch_assoc()){
		...
		$con = mysqli_connect("localhost","root");
				mysqli_select_db($con, "bughound");
		$sql= mysqli_query($con,"SELECT distinct emp_name from employees");
		while ($row = $sql->fetch_assoc()){
		...
		$con = mysqli_connect("localhost","root");
				mysqli_select_db($con, "bughound");
		$sql= mysqli_query($con,"SELECT distinct priority from areas");
		while ($row = $sql->fetch_assoc()){
		...
		$con = mysqli_connect("localhost","root");
				mysqli_select_db($con, "bughound");
		$sql= mysqli_query($con,"SELECT distinct resolution from areas");
		while ($row = $sql->fetch_assoc()){
		...
		$con = mysqli_connect("localhost","root");
				mysqli_select_db($con, "bughound");
		$sql= mysqli_query($con,"SELECT distinct resolution_version from areas");
		while ($row = $sql->fetch_assoc()){
