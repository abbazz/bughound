...
?>
	...
	<p>
		...
		<option selected value="<?=$rows1[1]?>"> <?=$rows1[1]?>,<?=$rows1[20]?>,<?=$rows1[21]?></option>
		<?php } ?>
		<?php
		$con = mysqli_connect("localhost","root");
				mysqli_select_db($con, "bughound");
		...
		<br>
		<input type="button" value="Add attachment" onclick="go_home1()"></input> <input type="button" value="View attachment" onclick="go_home2()"></input>
		<br>
